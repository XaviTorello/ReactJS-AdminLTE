        ...
        var Table = React.createClass({
            ...
            render: function () {
                ...
                var rowsList = that.props.rows.map(function (rowEntry, idRow) {
                    ...
                    //extract the values for this date
                    var values = rowEntry.values.map ( function (value, idValues){
                        ...
                        return (<td key={idValues} aria-label={value}>{formatedValue}</td>)
                    });
                ...
                if (that.state.chooser) {
                    ...
                    tableChooser = (
                        <TableChooser options={options} title="Tipus:" parentID={that.props.id}  type={that.state.chooserType}/>
                    );

                }


                return (<div id={"div_" + that.props.id}>
